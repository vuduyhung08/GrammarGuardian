            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                        ...
                        <form action="UserWalletManageController" class="d-flex"
                            style="margin-bottom: 15px; width: 30%">
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${order.image != null}">
                                                    <img src="data:image/png;base64,${order.image}" style="width: 100px"
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item"><a class="page-link"
                                                href="UserWalletManageController?status=${status}&index=${selectedPage-1}">«</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                                <c:forEach var="i" begin="1" end="${endP}">
                                    <li class="page-item ${i == selectedPage ? " active" : "" }"> <a class="page-link"
                                            href="UserWalletManageController?status=${status}&index=${i}">${i}</a>
                                    <li>
                                </c:forEach>
                                <c:choose>
