                                ...
                                <c:forEach items="${LIST_USER}" var="user" varStatus="count">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${!user.isActive}">
                                                <a  href="ChangeUserStatusController?userId=${user.id}" class="btn btn-success">
                                                    Enable
                                                </a>
                                            </c:if>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination" style="display: flex">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item"><a class="page-link" href="GetAllUserController?search=${search}&index=${selectedPage-1}">«</a></li>
                                    </c:otherwise>
                                </c:choose>
                                <c:forEach var="i" begin="1" end="${endP}">
                                <li class="page-item ${i == selectedPage ? "active" : "" }"> <a class="page-link" href="GetAllUserController?search=${search}&index=${i}">${i}</a> <li>
                                </c:forEach>
                                <c:choose>
