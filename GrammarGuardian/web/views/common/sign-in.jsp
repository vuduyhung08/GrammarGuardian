                    ...
                    <div class="form-container sign-up-container">
                        ...
                        <form action="RegisterController" method="post">
                            ...
                            <div style="display: flex" class="form-control">
                                ...
                                <input style="margin-left: 5px" class="form-control" type="text" placeholder="LastName"
                            ...
                            <input type="password" placeholder="Confirm password" name="repass" id="confirmpassword"
                                required />
                    ...
                    <div class="form-container sign-in-container">
                        <form action="LoginController" method="POST">
                            ...
                            <div class="social-container">
                                <a href="https://www.facebook.com/dialog/oauth?client_id=1509092289871952&redirect_uri=http://localhost:8080/FBK74/login-facebook"
                                    class="social" style="
