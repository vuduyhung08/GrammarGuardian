                ...
                <div class="flex flex-col md:flex-row justify-between items-start">
                    ...
                    <div class="mt-8 md:mt-0 md:ml-10 w-full max-w-lg">
                        ...
                        <div class="relative overflow-x-auto">
                            ...
                            <nav aria-label="Page navigation example" style="display: flex; justify-content:center;margin-top: 15px;">
                                <ul class="pagination">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="TransitionHistoryController?index=${selectedPage-1}">«</a></li>
                                            </c:otherwise>
                                        </c:choose>
                                        <c:forEach var="i" begin="1" end="${endP}">
                                        <li class="page-item ${i == selectedPage ? "active" : "" }"> <a class="page-link" href="TransitionHistoryController?index=${i}">${i}</a> <li>
                                        </c:forEach>
                                        <c:choose>
                            ...
                            <a href="SendWalletRequestPageController" class="btn btn-success" style="float: right; margin-top: 15px;">Add fund</a>
                        </div>
