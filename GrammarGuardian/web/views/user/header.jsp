...
<header class="p-3 text-bg-primary " style="background: linear-gradient(to right, #2F80ED, #56CCF2);">
    <div class="container">
        <div
            ...
            >
            <ul
                class="nav col-lg-auto me-lg-auto justify-content-center mb-md-0"      style="margin-right: 30px !important" 
                >
            ...
            <div class="text-end button-header nav col-3 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <c:if test="${sessionScope.USER != null }">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <a class="dropdown-item " href="TransitionHistoryController">Wallet: <fmt:formatNumber value="${WALLET}" pattern="#"/> Point</a>
