                    ...
                    <div class="flex flex-col md:flex-row">
                        <div class="w-full md:w-1/2 p-5 border-b md:border-b-0 md:border-r">
                            ...
                            <form action="profile" method="post">
                                ...
                                <div class="mb-4 relative">
                                    <label for="old-password" class="block text-gray-700 text-sm font-bold mb-2">Current
                                        Password</label>
                                    <input name="oldpassword" type="password" id="old-password"
                                        placeholder="Your current password"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    <i class="fas fa-eye-slash password-toggle cursor-pointer absolute right-3 top-9"
                                        id="toggle-old-password" data-input="old-password"></i>
                                </div>
                                <div class="mb-4 relative">
                                    <label for="new-password" class="block text-gray-700 text-sm font-bold mb-2">New
                                        password</label>
                                    ...
                                    <i class="fas fa-eye-slash password-toggle cursor-pointer absolute right-3 top-9"
                                        id="toggle-new-password" data-input="new-password"></i>
                                </div>
                                <div class="mb-6 relative">
                                    <label for="confirm-password"
                                        class="block text-gray-700 text-sm font-bold mb-2">Confirm new password</label>
                                    ...
                                    <i class="fas fa-eye-slash password-toggle cursor-pointer absolute right-3 top-9"
                                        id="toggle-confirm-password" data-input="confirm-password"></i>
                                ...
                                <div class="flex items-center justify-between">
                                    <button id="btn-submit" type="submit"
                                        class="inline-block align-baseline font-bold text-sm text-gray-500 hover:text-gray-800 border border-gray-300 py-2 px-4 rounded hover:border-gray-500 focus:outline-none focus:border-gray-500">
                                        Save
                                    </button>
                        ...
                        <div class="w-full md:w-1/2 p-5">
                            <div class="flex items-center mb-5">
                                ...
                                <h2 class="text-xl font-bold pl-3" style="color: #cf6203;">Set a strong password to keep
                                    your account secure.</h2>
                            </div>
                            <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4" role="alert">
                                <p class="font-bold">Make sure it has 8 or more characters, at least 1 uppercase letter,
                                    1 lowercase letter and 1 special character</p>
